 ...
 * @author darlyn
 */
public class AlmacenGeneral extends javax.swing.JFrame {

    ConexionDB con = new ConexionDB();
    Connection conexion = con.conectar();
    public AlmacenGeneral() {
        initComponents();
        mostrarDatos();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "GENERAL", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Fira Sans", 1, 24), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 600, 260));
        ...
        jPanel1.add(btnHome, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 330, 220, 90));
    ...
    private void mostrarDatos(){
        ...
        String consultasSQL = "SELECT * FROM medicamentoss"; // aqui creamos la consulta que queremos ejecutar
        //segun la funcion
