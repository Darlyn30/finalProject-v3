 ...
 * @author darlyn
 */
public class AlmacenAntibioticos extends javax.swing.JFrame {

    ConexionDB con = new ConexionDB();
    Connection conexion = con.conectar();
    public AlmacenAntibioticos() {
        initComponents();
        mostrarDatos();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "ANTIBIOTICOS", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Fira Sans", 1, 36), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 630, 320));
        ...
        jPanel1.add(btnHome, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 380, 290, 90));
    ...
    private void btnHomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHomeActionPerformed
        ...
        String consultasSQL = "SELECT * FROM medicamentoss where descripcion like '%Analgésico%'"; // aqui creamos la consulta que queremos ejecutar
        //segun la funcion
